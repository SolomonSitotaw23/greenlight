...
// returns true if errors map doesn't contain any entries
func (v *Validator) Valid() bool {
	return len(v.Errors) == 0
}

// adds an error message to the map if it isn't already there
...
// returns true if a specific value is in a list of permittedValue
